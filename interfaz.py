...
class InterfazPrediccion(tk.Tk):
    ...
    def crear_interfaz(self):
        ...
        opciones_valores = {
            'Trabajo del padre': ['Trabajo Autónomo, Empresarial o Administrativo', 'Trabaja en el hogar, es pensionado, no trabaja o estudia', 'Empresario o Gerencial / Otras Ocupaciones', 'Trabajo Profesional', 'No sabe / No aplica'],
            'Nivel de educación del padre': ['Educación Primaria', 'Educación Secundaria', 'Educación Profesional o superior', 'Educación Técnica o Tecnológica', 'Ninguno, no aplica o no sabe'],
            'Trabajo de la madre': ['Trabajo Autónomo, Empresarial o Administrativo', 'Trabaja en el hogar, es pensionado, no trabaja o estudia', 'Empresario o Gerencial / Otras Ocupaciones', 'Trabajo Profesional', 'No sabe / No aplica'],
            'Nivel de educación de la madre': ['Educación Primaria', 'Educación Secundaria', 'Educación Profesional o superior', 'Educación Técnica o Tecnológica', 'Ninguno, no aplica o no sabe'],
            'Cuántos cuartos tiene en el hogar': ['1', '2', '3', '4', '5', '6'],
            'Dedicación a la lectura diaria':['30 minutos o menos', 'Entre 30 y 60 minutos', 'Entre 1 y 2 horas', 'Más de 2 horas', 'No leo por entretenimiento'],
            'Tiempo dedicado en internet': ['30 minutos o menos', 'Entre 30 y 60 minutos', 'Entre 1 y 3 horas', 'Más de 3 horas', 'No Navega Internet'],
            'Número de personas en el hogar' : ['1 a 2', '3 a 4', '5 a 6', '7 a 8', '9 o más'],
            'Estrato de la vivienda':['1', '2', '3', '4', '5', '6'],
            'Frecuencia con la que consume carne, pescado o huevo': ['Nunca o rara vez comemos eso', '1 o 2 veces por semana', '3 a 5 veces por semana', 'Todos o casi todos los días'],
            'Frecuencia con la que consume leche o derivados': ['Nunca o rara vez comemos eso', '1 o 2 veces por semana', '3 a 5 veces por semana', 'Todos o casi todos los días'],
